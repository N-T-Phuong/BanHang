...
namespace BanHang.Controllers
{
    public class OrderDetailsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id,Product_id,Order_id,Price,Quantity,TotalOrder")] OrderDetail orderDetail)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,Product_id,Order_id,Price,Quantity,TotalOrder")] OrderDetail orderDetail)
        {
            if (ModelState.IsValid)
            {
